...
public final class CSVPrinter implements Flushable, Closeable {
   ...
   *
   * <p>Comments will always begin on a new line and occupy a least one full line. The character
   * specified to start comments and a space will be inserted at the beginning of each new line in
   * the comment. If comments are disabled in the current CSV format this method does nothing.
   *
  ...
  /**
   * Prints the given values a single record of delimiter separated values followed by the record
   * separator.
   *
   ...
   *
   * <p>If the given collection only contains simple objects, this method will print a single record
   * like {@link #printRecord(Iterable)}. If the given collections contains nested
