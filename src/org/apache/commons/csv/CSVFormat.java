 ...
 *
 * <p>You can extend a format by calling the {@code with} methods. For example:
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>Calling {@link #withHeader(String...)} let's you use the given names to address values in a
 * {@link CSVRecord}, and assumes that your CSV source does not contain a first record that also
 * defines column names.
 *
 * <p>If it does, then you are overriding this metadata with your names and you should skip the
 * first record by calling {@link #withSkipHeaderRecord(boolean)} with {@code true}.
 *
 * <h2>Parsing</h2>
 *
 ...
 * columns, by using {@link #withHeader(String...)} with no arguments:
 *
 * <pre>
...
public final class CSVFormat implements Serializable {
   ...
   *
   * <ul>
   *   <li>{@link #withDelimiter(char) withDelimiter(',')}
   *   <li>{@link #withQuote(char) withQuote('"')}
   *   <li>{@link #withRecordSeparator(String) withRecordSeparator("\r\n")}
   *   <li>{@link #withIgnoreEmptyLines(boolean) withIgnoreEmptyLines(false)}
   *   <li>{@link #withAllowMissingColumnNames(boolean) withAllowMissingColumnNames(true)}
   * </ul>
   *
  ...
  public static final CSVFormat INFORMIX_UNLOAD_CSV =
      DEFAULT.withDelimiter(COMMA).withQuote(DOUBLE_QUOTE_CHAR).withRecordSeparator(LF);
   ...
   *   <li>withQuote('"')
   *   <li>withRecordSeparator("\r\n")
   *   <li>withIgnoreSurroundingSpaces(true)
   * </ul>
   *
   * @see Predefined#TDF
   */
  ...
  public static CSVFormat newFormat(final char delimiter) {
    return new CSVFormat(
        delimiter, null, null, null, null, false, false, null, null, null, null, false, false,
        false, false, false);
  }
   ...
   * escaped or encapsulated as needed. Useful when one wants to avoid creating CSVPrinters.
   *
   ...
   * @since 1.4
   */
  public void print(final Object value, final Appendable out, final boolean newRecord)
      throws IOException {
   ...
   */
  private void printAndEscape(
      final CharSequence value, final int offset, final int len, final Appendable out)
      throws IOException {
    int start = offset;
    int pos = offset;
  ...
  /**
   * Returns a new {@code CSVFormat} with the missing column names behavior of the format set to
   * {@code true}
   *
  ...
  /**
   * Returns a new {@code CSVFormat} with the missing column names behavior of the format set to the
   * given value.
   *
  ...
  /**
   * Returns a new {@code CSVFormat} with the comment start marker of the format set to the
   * specified character.
   *
  ...
  /**
   * Returns a new {@code CSVFormat} with the delimiter of the format set to the specified
   * character.
   *
  ...
  /**
   * Returns a new {@code CSVFormat} with the escape character of the format set to the specified
   * character.
   *
   * @param escape the escape character
   * @return A new CSVFormat that is equal to his but with the specified character as the escape
   *     character
   * @throws IllegalArgumentException thrown if the specified character is a line break
   */
   ...
   * <p>The header is also used by the {@link CSVPrinter}.
   *
   * @param metaData the metaData for the header, {@code null} if disabled, empty if parsed
   *     automatically, user specified otherwise.
   * @return A new CSVFormat that is equal to this but with the specified header
   * @throws SQLException SQLException if a database access error occurs or this method is called on
   *     a closed result set.
  ...
  /**
   * Returns a new {@code CSVFormat} with the header of the format set to the given values. The
  ...
  /**
   * Returns a new {@code CSVFormat} with the empty line skipping behavior of the format set to
   * {@code true}.
   *
  ...
  /**
   * Returns a new {@code CSVFormat} with the empty line skipping behavior of the format set to the
   * given value.
   *
  ...
  /**
   * Returns a new {@code CSVFormat} with the trimming behavior of the format set to the given
   * value.
   *
   * @param ignoreSurroundingSpaces the trimming behavior, {@code true} to remove the surrounding
   *     spaces, {@code false} to leave the spaces as is.
   * @return A new CSVFormat that is equal to this but with the specified trimming behavior.
   */
  ...
  /**
   * Returns a new {@code CSVFormat} with conversions to and from null for strings on input and
   * output.
   *
   * <ul>
   *   <li><strong>Reading:</strong> Converts strings equal to the given {@code nullString} to
  ...
  /**
   * Returns a new {@code CSVFormat} with the quoteChar of the format set to the specified
   * character.
   *
  ...
  /**
   * Returns a new {@code CSVFormat} with the output quote policy of the format set to the specified
   * value.
   *
  ...
  /**
   * Returns a new {@code CSVFormat} with the record separator of the format set to the specified
   * character.
   *
   ...
   *
   * @return A new CSVFormat that is equal to this but with the the specified skipHeaderRecord
   *     setting.
   * @see #withSkipHeaderRecord(boolean)
   * @see #withHeader(String...)
   * @since 1.1
