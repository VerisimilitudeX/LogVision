...
/**
 * The IlluminaLogAnalyzer class provides methods to read and analyze
 * Illumina log entries, including computations for averages, totals,
 * and other metrics. All data is stored in an ArrayList of
 * IlluminaLogEntryExtended objects. 
 */
public class IlluminaLogAnalyzer {
    ...
    /**
     * Constructs an IlluminaLogAnalyzer with an empty list of records.
    ...
    /**
     * Reads a file from the assets folder and populates the records list
     * with parsed IlluminaLogEntryExtended objects. lines that don't parse
     * are skipped.
     *
    ...
    /**
     * Prints all the log entries to standard output. 
     * you can use this to see raw data quickly.
     */
    ...
    /**
     * Counts how many times each HPC node was used, based on the HPC node
     ...
     *
     * @return the IlluminaLogEntryExtended with the maximum read count, or null if there are no records
     */
